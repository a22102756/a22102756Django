...
urlpatterns = [
    ...
    path('praia/', views.search_praia, name='search_praia'),
    path('editCourse/<int:course_id>', views.edit_course_page_view, name='editCourse'),
    path('apagaCourse/<int:post_id>', views.apaga_course_page_view, name='apagaCourse'),
    path('add_comment/<int:post_id>/', views.add_comment, name='add_comment'),
    path('publication/<int:post_id>/', views.add_to_publication, name='publication'),
